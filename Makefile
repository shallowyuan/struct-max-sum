...
#MAT$(PROJECT)_SRC :=$(shell find matlab/+$(PROJECT)/private/ -name "*.cpp")
ifneq ($(MATLAB_DIR),)
...
LIBRARIES += glog gflags protobuf leveldb snappy \
	lmdb boost_system hdf5_hl hdf5_cpp hdf5 m \
...
MEXFLAGS := -Iinclude $(COMMON_FLAGS)  CXXFLAGS="\$$CXXFLAGS -std=c++11"

SSRC := /home/zehuany/libs/code/action_matlab/lmdb/src/caffe_pb_.cc

TSRC := /home/zehuany/libs//code/action_matlab/lmdb/+caffe_pb/private/caffe_pb_.$(MAT_SO_EXT)

matlmdb: $(TSRC)

$(TSRC): $(SSRC) $(STATIC_NAME)
	@ echo MEX $<
	$(Q)$(MATLAB_DIR)/bin/mex -output $@ $< $(MEXFLAGS) $(STATIC_NAME)
...
$(MAT$(PROJECT)_SO): $(MAT$(PROJECT)_SRC) $(STATIC_NAME)
	...
	$(Q)$(MATLAB_DIR)/bin/mex $(MAT$(PROJECT)_SRC) \
			CXX="$(CXX)" \
			CXXFLAGS="\$$CXXFLAGS $(MATLAB_CXXFLAGS) -std=c++11" \
